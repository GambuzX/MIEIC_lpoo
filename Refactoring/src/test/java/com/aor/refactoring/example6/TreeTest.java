...
public class TreeTest {
    ...
    public void testTreeCreation() {
        ...
        assertEquals(tree.getLocationLatitude(), "41.177772696363114");
        assertEquals(tree.getLocationLongitude(), "-8.59843522310257");
        assertEquals(tree.getLocationName(), "FEUP");
    }
    ...
    public void testTreeSetLocation() {
        ...
        assertEquals(tree.getPlantedAt(), date);
        assertEquals(tree.getLocationLatitude(), "loclat");
        assertEquals(tree.getLocationLongitude(), "loclon");
        assertEquals(tree.getLocationName(), "locname");
    }
